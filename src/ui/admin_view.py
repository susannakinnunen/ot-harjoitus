...
class AdminView:
    ...
    def _initialize(self):
        ...
        stretch_name_label = ttk.Label(
            master=self._frame, text="Venyttelyn nimi")
        self._stretch_name_entry = ttk.Entry(master=self._frame)

        stretch_instructions_label = ttk.Label(
            master=self._frame, text="Venyttelyohjeet")
    ...
    def add_stretch_handler(self):
        ...
        self._stretching_service.add_stretch(
            stretch_name, stretch_instructions)
