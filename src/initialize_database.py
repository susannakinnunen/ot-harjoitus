...
def create_tables(connection):
    ...
    sql_bodypart_stretch = "CREATE TABLE BodypartStretches (id INTEGER PRIMARY KEY, bodypart_id INTEGER REFERENCES Bodyparts, stretch_id INTEGER REFERENCES Stretches);"
