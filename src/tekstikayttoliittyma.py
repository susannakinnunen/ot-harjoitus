...
def ui():
    ...
    while True:
        ...
        komento = input("Tulosta kehonosat painamalla 'A', hae venytys painamalla 'B', lopeta painamalla 'X' \n")
        if komento == "A":
...
if __name__ == "__main__":
    ...
    BS = BodypartStretch.BodypartStretch(database_connection.get_database_connection())
