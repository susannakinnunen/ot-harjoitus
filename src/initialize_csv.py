...
class InitializeCSV():
    ...
    def initialize_bodyparts_csv(self):
        ...
        self.bodypart_repository.write_bodyparts_to_file_and_database(self.bodypart_name,self.strech_name)

    def initialize_stretches_csv(self):
        self.stretch_repository.delete_all()
        self.stretch_repository.write_stretches_to_file_and_database(self.strech_name,self.strech_instructions)
