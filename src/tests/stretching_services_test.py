...
class TestStretchingService(unittest.TestCase):
    ...
    def test_add_bodypart(self):
        ...
        self.assertEqual(
            vastaus, f"Lisätty kehonosa ja venytys: {bodypart} ja {stretch}")
    ...
    def test_add_stretch(self):
        ...
        vastaus = self.stretching_service.add_stretch(
            stretch_name, description)
    ...
    def test_add_combination(self):
        ...
        vastaus = self.stretching_service.add_combination(
            bodypart_name, stretch_name)
